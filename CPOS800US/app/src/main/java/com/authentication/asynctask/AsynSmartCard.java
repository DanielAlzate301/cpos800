...
public class AsynSmartCard extends Handler {
	...
	public static final  int SCARD_LOAN		=	0x0001;
	public static final  int SCARD_DEBIT		=	0x0002;
	public static final  int SCARD_QUASI_CREDIT		=	0x0003;
	public static final  int SCARD_ELECTRONIC_CASH		=	0x0004;

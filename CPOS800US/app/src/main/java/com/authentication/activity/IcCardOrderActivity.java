...
import com.authentication.asynctask.AsynIcCardOrder;
import com.authentication.asynctask.AsynIcCardOrder.OnSendOperCmdListener;
...
public class IcCardOrderActivity extends Activity implements OnClickListener {
				...
				if (SerialPortManager.getInstance().isUpGpio()) {
					...
					handler.post(new Runnable() {
						...
						public void run() {
							...
							Toast.makeText(getApplicationContext(), "ICard msn",
	...
	static public byte[] hexToByteArray(String inHex)
	{

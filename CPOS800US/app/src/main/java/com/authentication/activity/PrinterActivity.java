...
import com.authentication.utils.DataValidator;
...
public class PrinterActivity extends Activity implements OnClickListener,
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.paperPrint_printBtn:// ��ӡ����������
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		case R.id.barcodeType_check:
			...
			break;
		case R.id.qrcodeType_check:// ��ά������
			mQrcodeType = position;
			break;
		case R.id.flashPicType_check:// flashͼƬѡ��

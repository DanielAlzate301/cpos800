...
import com.authentication.utils.Constant;
...
public class SmartCardAPI {
	...
	public final  int SCARD_LOAN		=	0x0001;
	public final  int SCARD_DEBIT		=	0x0002;
	public final  int SCARD_QUASI_CREDIT		=	0x0003;
	public final  int SCARD_ELECTRONIC_CASH		=	0x0004;
...
//		Mutex.unlock();
	...
	private static final int PORTER_PROTOCOL_SD0 = 0xCA;
	private static final int PORTER_PROTOCOL_SD1 = 0xDF;
	private static final int PORTER_PROTOCOL_DATA = 0x35;

	private static final int PORTER_PROTOCOL_CMD = 0x36;

	private static final int PORTER_PROTOCOL_MTU = 0x80;
